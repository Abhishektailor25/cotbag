...
<div id="editbar">
  ...
  <div class="editbarDiv"><img src="img/cd-icon-download.png" class="editbarIcon editbarIconLeft">
      ...
      <div id="editbarUse" onClick="#" class="editbarDiv"><img src="img/cd-icon-use.png" class="editbarIcon editbarIconLeft">
    <p class="editbarText"><?php echo $buttons3; ?></p>
  </div>
      <div id="editbarDelete" onClick="#" class="editbarDiv"><img src="img/cd-icon-qtrash.png" class="editbarIcon editbarIconLeft">
    <p class="editbarText"><?php echo $buttons4; ?></p>
  </div>
      <img onClick="hideEditBar();" src="img/cd-icon-close-black.png" class="editbarIcon editbarIconRight"> </div>
...
<div id="dropzone" class="dropzone" 
     ...
     ondrop="drop(event)">
      <p> <img src="img/cd-icon-upload-big.png"><br>
    <?php echo $imagebrowser4; ?> </p>
    </div>
<p class="folderInfo"><?php echo $imagebrowser2; ?> <span id="finalcount"></span> <?php echo $imagebrowser3; ?> - <span id="finalsize"></span>
      ...
      <img title="Block" src="img/cd-icon-block.png" class="headerIcon floatRight" onClick="window.location.href = 'pluginconfig.php?file_style=block';"> <img title="Quick Edit" id="qEditBtnOpen" src="img/cd-icon-qedit.png" class="headerIcon floatRight" onClick="toogleQEditMode();"> <img title="Quick Edit" id="qEditBtnDone" src="img/cd-icon-done.png" class="headerIcon floatRight" onClick="toogleQEditMode();">
      <?php } ?>
    </p>
<div id="files">
      <?php
...
<div id="uploadImgDiv" class="lightbox popout">
    ...
    <br>
    <h3 class="settingsh3" style="font-size:12px;font-weight:lighter;"><?php echo $uploadpanel2; ?><br>
          <span style="font-weight:bolder;">"<?php echo $useruploadfolder; ?>"</span> (<?php echo $uploadpanel3; ?>)</h3>
    <br>
  </form>
    </div>
<?php if($show_settings) { ?>
<div id="settingsDiv" class="lightbox popout">
    ...
    <button class="headerBtn" onClick="$('#settingsDiv').hide(); $('#background3').slideUp(250, 'swing');"><img src="img/cd-icon-close.png" class="headerIcon"></button>
      ...
      <button class="headerBtn saveUploadPathA" onClick="updateImagePath();"><?php echo $buttons6; ?></button>
      <br class="saveUploadPathA">
      <br>
     <!-- <h3 class="settingsh3"><?php // echo $panelsettings4; ?></h3>-->
    ...
    <!--  <p class="uploadP" onClick="extensionSettings('no');"><img src="img/cd-icon-hideext.png" class="headerIcon"> <?php echo $panelsettings5; ?></p>
     ...
     <!-- <?php if($_SESSION["username"] != "disabled_pw"){ ?>
      <br>
      <h3 class="settingsh3"><?php echo $panelsettings7; ?></h3>-->
...
<noscript>
    <div class="noscript">
  <div id="folderError" class="noscriptContainer popout"> <b><?php echo $alerts1; ?></b><br>
        <br>
        <?php echo $alerts5; ?> <a href="http://www.enable-javascript.com/" target="_blank"><?php echo $alerts6; ?></a><br>
        <br>
        <?php echo $alerts4; ?> </div>
</div>
    </noscript>
<?php   
