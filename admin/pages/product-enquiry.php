<?php $table = 'enquiry_popup'; $page = 'dashboard?page=product-enquiry'; $PageHead = 'Product Enquiry';
			 ...
			 ?>
                <tr>
                 ...
                 <td><?php echo $showall[$i]['Mobile']; ?></td>
                  <td><?php echo $showall[$i]['Product_style']; ?></td>
                  <td><?php echo $showall[$i]['Description']; ?></td>
                  <td><?php echo $Common->showindatendtime($showall[$i]['CreatDate']); ?></td>
